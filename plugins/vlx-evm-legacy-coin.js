...
(function(){
  var mainnet, testnet, color, type, enabled, name, token, nickname, market, image, usdInfo, out$ = typeof exports != 'undefined' && exports || this;
  out$.mainnet = mainnet = {
    disabled: false,
    decimals: 18,
    txFee: '0.002',
  ...
  out$.name = name = 'Velas EVM Legacy';
  out$.token = token = 'vlx_evm_legacy';
